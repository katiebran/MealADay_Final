let app,debug0,http,fs,path;_083‍.w("../app",[["default",["app"],function(v){app=v}]]);_083‍.w("debug",[["default",["debug0"],function(v){debug0=v}]]);_083‍.w("http",[["default",["http"],function(v){http=v}]]);_083‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_083‍.w("path",[["default",["path"],function(v){path=v}]]);
...
function onError(error) {
  ...
  switch (error.code) {
    case 'EACCES':
      _083‍.g.console.error(bind + ' requires elevated privileges');
      process.exit(1);
      break;
    case 'EADDRINUSE':
      _083‍.g.console.error(bind + ' is already in use');
      process.exit(1);
      break;
    default:
      throw error;
